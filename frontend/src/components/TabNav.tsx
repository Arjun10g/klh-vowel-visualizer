...
const TABS: TabSpec[] = [
  ...
  { id: "live_audio", label: "Audio Monitor", shortcut: "7" },
];
...
export function TabNav() {
  ...
  return (
    <nav className="flex overflow-x-auto border-b border-slate-200 bg-slate-50 text-sm">
      {TABS.map((t) => {
        ...
        return (
          <button
            ...
            className={
              "shrink-0 border-b-2 px-4 py-2 transition " +
              (active
